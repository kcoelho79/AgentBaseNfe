...
[] detalhes da sessao , apos emitir a nota, nao aparece o valor na 
    div notas emitida
...
[x] cadastro de empresa - botao para preencher os dados busca da receita, 
mas não grava no banco (ClienteTomador) 
[x] endereço tmb buscar cep - preencher os dados
[x] campo whatsapp cadastro ususario,telefone salva sem o cod paig 
[x] cadastro não ativa usuario empresa
...
NFSE
  ...
  [x] criar list ClienteTomador na aba Empresas 
  [x] criar list ClienteTomado Menu ClientesTomador tabela numero de notas emitidas
...
Sessoes 
    ...
    [x] salvar os estados nas mensagens
