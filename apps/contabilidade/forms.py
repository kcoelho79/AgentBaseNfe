...
class EmpresaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'cnae_principal': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ex: 62.04-0-00 - Consultoria em TI'}),
            'cnae_secundarios': forms.Textarea(attrs={'class': 'form-control', 'rows': 5, 'placeholder': 'Um CNAE por linha:\n62.01-5-00 - Desenvolvimento de software\n62.02-3-00 - Suporte técnico'}),
